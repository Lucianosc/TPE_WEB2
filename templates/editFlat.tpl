...
<div>
    ...
    <form action="editFlat" method="post">
        ...
        <input type="text" name="input_edit_name" value="{$flat->nombre}">

        <label for="address">Address</label>
        <input type="text" name="input_edit_address" value="{$flat->direccion}">

        <label for="price">Price</label>
        <input type="number" name="input_edit_price" value="{$flat->precio}">
