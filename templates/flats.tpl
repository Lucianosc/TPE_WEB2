                            ...
                            <div class="row">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        {if $id_flat eq false}
                                        <td><a href="flat/{$flat->id_departamento}"><button type="button"
                                                    class="btn btn-secondary">Ver
                                                    detalle</button></a></td>
                                        {/if}
                                        {if $sessionUser eq true}
                                        <td><a href="editFlat/{$flat->id_departamento}"><button type="button"
                                                    class="btn btn-secondary">Editar</button></a></td>
                                        <td><a href="deleteFlat/{$flat->id_departamento}"><button type="button"
